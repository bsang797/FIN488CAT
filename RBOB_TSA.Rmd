...
eia_fin_gasoline <- tibble::tribble(
  ...
  'PET.WGFRPUS2.W', 'gasoline_production', 'input',
  # per DAY
  
  # 'PET.WGRRPUS2.W', 'reformulated_gasoline_production', 'input', #reformulated gasoline 
  # per DAY
  
  # 'PET.WG4TP_NUS_2.W', 'conventional_gasoline_production', 'input',
  # per DAY
  ...
  'PET.WGFUPUS2.W', 'consumption', 'output',
  # per DAY
